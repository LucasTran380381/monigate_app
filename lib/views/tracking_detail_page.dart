...
class TrackingDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(TrackingDetailController());
...
class CircleContactsNum extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration:
          const BoxDecoration(shape: BoxShape.circle, color: Colors.lime),
        ...
        Container(
          ...
          child: Text(
            ...
            style: Theme.of(context)
                .textTheme
                .headline6!
                .merge(TextStyle(color: Util.primaryColor.withOpacity(0.7))),
          ),
        ),
        Card(
          shape:
